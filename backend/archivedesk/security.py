...
class SecretStore:
    ...
    Windows uses DPAPI bound to the current user. Other platforms use a
    mode-0600 plaintext file. Container deployments must protect the data
    volume at the host and storage layer.
    """
